  ...
  return (
    <div className="post">
      ...
      <p className="postDesc">
        ...
        Lorem ipsum doalr its not the wayLorem ipsum doalr its not the way Lorem
        ipsum doalr its not the way Lorem ipsum doalr its not the way Lorem
        ipsum doalr its not the wayLorem ipsum doalr its not the way
      </p>
    </div>
  );
};
